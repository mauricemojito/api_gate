"""
Django settings for API Gate project.
...
SECRET_KEY = env("SECRET_KEY", default="PPMlvUEGXGSdwnowOkSwGAbUwNnKYJWUgsTXozAV")
...
WSGI_APPLICATION = "api_gate.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="api_gate"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "api_gate_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="api_gate-media")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "API Gate",
    "DESCRIPTION": "Dynamic Api generator",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("API Gate"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Dynamic Api generator"),
...
LOGGING = {
    ...
    "loggers": {
        ...
        "api_gate": {
            "handlers": ["console"],
            "level": env("API_GATE_LOG_LEVEL", default="INFO"),
        },
    },
}
